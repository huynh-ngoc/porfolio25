  ...
  return (
    ...
    >
      ...
      <p className="text-[clamp(1rem,2.5vw,1.125rem)] text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
        I&rsquo;m a senior Software Engineering student at UC Irvine with a strong passion for building real-world web, mobile, and data-driven applications.
        ...
        I&rsquo;m currently looking for a full-time opportunity where I can contribute, learn, and grow as a developer.
      </p>
